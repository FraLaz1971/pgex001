...
int main(){
   ...
   * PGLAB to label it. The x-axis runs from 0 to 10, and u from 0 to 30
   */
  cpgenv(0.0,10.0,0.0,30.0,0,1);
  cpglab("(x)","(y)","PGPLOT c Example 1: y = x\\u2\\d");
  /*
   *Mark five points (coordinates in arrays XS and YS), using symbol number 9
   */
  cpgpt(5,xs,ys,9);
  /*
